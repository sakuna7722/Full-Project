    ...
    <section className="px-4 py-16 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50 min-h-screen flex items-center justify-center">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl sm:text-6xl font-bold mb-6 bg-gradient-to-r from-gray-800 via-blue-600 to-purple-600 bg-clip-text text-transparent">
            Digital Freelancing
          </h1>
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Kickstart your freelancing journey with essential skills, proven strategies, and expert guidance designed for beginners.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 p-8 mb-8 border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            {[
              ...
              <div
                key={index}
                className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border border-gray-200 hover:border-orange-300 transition-all duration-300 group hover:shadow-lg"
              >
          ...
          <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl p-6 border border-orange-200">
            <div className="text-center mb-4">
              <h3 className="text-2xl font-bold text-gray-800 mb-2">Bonus Features Included</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="text-center p-4">
                ...
                <h4 className="font-semibold text-gray-800 mb-1">LeadsArk Affiliate Training</h4>
                <p className="text-sm text-gray-600">Recordings of Previous Weekly Training Sessions</p>
              </div>
              ...
              <div className="text-center p-4">
                ...
                <h4 className="font-semibold text-gray-800 mb-1">Weekly Live Training</h4>
                <p className="text-sm text-gray-600">Real-time interaction with experts</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 text-center">
            <div className="p-3 bg-blue-50 rounded-lg">
              <div className="text-blue-600 font-bold text-sm">Lifetime Access</div>
            </div>
            <div className="p-3 bg-green-50 rounded-lg">
              <div className="text-green-600 font-bold text-sm">Certificate</div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold text-gray-800">What Students Say</h3>
          </div>
          <div className="flex items-center space-x-4">
            <div className="flex-1">
              <p className="text-gray-600 italic mb-2">
                "This course gave me the confidence to start my freelancing career. The step-by-step approach made everything clear!"
              </p>
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          ...
          <button className="px-8 py-4 rounded-xl bg-gradient-to-r from-orange-500 to-pink-500 text-white font-semibold hover:from-orange-600 hover:to-pink-600 transition-all duration-300 transform hover:scale-105 shadow-lg">
        ...
        <div className="text-center mt-8">
          <div className="flex justify-center gap-6 flex-wrap text-sm text-gray-600">
            ...
            <div className="flex items-center">
              <span className="text-green-500 mr-2">✓</span> Instant Access
            </div>
            <div className="flex items-center">
              <span className="text-green-500 mr-2">✓</span> Mobile Friendly
            </div>
          </div>
        </div>
      </div>
